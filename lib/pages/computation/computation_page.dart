...
class _ComputationPageState extends State<ComputationPage>
  ...
  final TextEditingController _discount1Controller =
      TextEditingController();
  final TextEditingController _discount2Controller =
      TextEditingController();
  ...
  void _calculateMargin() {
    ...
    if (cost == null || price == null) {
      setState(() {
        _marginError = 'Semua kolom wajib diisi dengan angka valid!';
      });
      return;
    }
    ...
    if (cost < 0 || price < 0) {
      setState(() {
        _marginError = 'Nominal tidak boleh bernilai negatif!';
      });
      return;
    }
  ...
  void _calculateDiscount() {
    ...
    final originalPrice = _parseSafeDouble(
    ...
    if (disc1Str.isEmpty && disc2Str.isNotEmpty) {
      setState(() {
        _discountError =
            'Diskon 1 wajib diisi terlebih dahulu sebelum mengisi Diskon 2!';
      });
      return;
    }

    final disc1 = _parseSafeDouble(
      _discount1Controller.text,
    );

    final disc2 = _parseSafeDouble(
    ...
    if (originalPrice == null) {
      setState(() {
        _discountError =
            'Harga awal wajib diisi angka valid!';
      });
      return;
    }
    ...
    if (disc1 == null) {
      setState(() {
        _discountError = 'Diskon 1 wajib diisi!';
      });
      return;
    }
    ...
    if (disc1 < 0 ||
      ...
      setState(() {
        _discountError =
            'Persentase diskon harus di antara 0% s/d 100%!';
      });
      return;
    }
    ...
    final afterDisc1 =
        originalPrice - (originalPrice * (disc1 / 100));

    final finalPrice =
        afterDisc1 - (afterDisc1 * (disc2 / 100));
    ...
    print('Discount 1        : $disc1');
    print('Discount 2        : $disc2');
    print('After Discount 1  : $afterDisc1');
    print('Final Price       : $finalPrice');
    print('Total Savings     : $totalSavings');
    print('Effective Discount: $effectiveDiscount');
    print('==================================');
    ...
    setState(() {
      _discountResult = {
        ...
        'effectiveDisc':
            '${_percentFormat.format(effectiveDiscount)}%',
      };
    });
  }
  ...
  void _calculateTax() {
    ...
    final revenue =
        _parseSafeDouble(_revenueController.text);

    if (revenue == null) {
      setState(() {
        _taxError =
            'Omzet/Penjualan wajib diisi angka valid!';
      });
      return;
    }
    ...
    if (revenue < 0) {
      setState(() {
        _taxError =
            'Omzet tidak boleh bernilai negatif!';
      });
      return;
    }
    ...
    if (_businessType ==
      ...
      if (revenue <= 500000000) {
        ...
        pphInfo =
            '0.5% dari (Omzet - 500 Juta)';
      } else {
        setState(() {
          _taxError =
              'Omzet melebihi Rp 4.8 Miliar. Wajib PPh Tarif Normal & Wajib PKP (PPN 12%).';
        });
        return;
      }
    } else if (_businessType ==
      ...
      setState(() {
        _taxError =
            'Berdasarkan PP 20/2026, CV/PT baru tidak berhak atas PPh Final 0,5%. Wajib menggunakan skema PPh Badan Normal (22% dari Laba Bersih) menggunakan pembukuan.';
      });
      return;
    }
    ...
    setState(() {
      _taxResult = {
        ...
        'netRevenue':
            _currencyFormat.format(netRevenue),
        'ppnStatus': ppnStatus,
      };
    });
  }
  ...
  Widget _buildDiscountTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          _infoCard(
            'Kalkulator Diskon Promo Bertingkat',
        ...
        children: [
          ...
          _customTextField(
            controller:
                _revenueController,
            label:
                'Total Omzet / Pendapatan Bruto (Rp)',
            hint:
                'Contoh: 25000000',
            icon:
                Icons
