...
/// 4. Konversi Kalender Hijriah:
///    - Menggunakan package `hijri_core`.
///    - Menggunakan engine FCNA untuk perhitungan konversi Gregorian ke Hijriah.
///    - Engine FCNA tidak memiliki batas tahun tetap sehingga dapat digunakan
///      untuk tanggal jauh sebelum tahun 1900.
...
class _DateConversionPageState extends State<DateConversionPage>
  ...
  TimeOfDay _birthTime = const TimeOfDay(
    hour: 0,
    minute: 0,
  );
  ...
  void initState() {
    ...
    // Hitung tanggal Hijriah saat halaman pertama kali dibuka
  ...
  void _calculateHijri(DateTime gregorianDate) {
    /*
      Gunakan UTC agar tanggal yang dikonversi tetap konsisten.

      Contoh:
      17 Agustus 1945
            ↓
      DateTime.utc(1945, 8, 17)
            ↓
      toHijri()
            ↓
      Umm al-Qura
            ↓
      Hari / Bulan / Tahun Hijriah
    */
    ...
    final int hDay = hijriDate.hd;
    final int hMonth = hijriDate.hm;
    final int hYear = hijriDate.hy;
  ...
  void _updateAgeCalculation() {
    ...
    final totalDifference = now.difference(
      birthDateTime,
    );
  ...
  // ==========================================
  // PICK TANGGAL MASEHI UNTUK KONVERSI HIJRIAH
  // RANGE: 1500 - 2100
  // ==========================================
  ...
  Future<void> _pickHijriSourceDate() async {
    final picked = await showDatePicker(
      ...
      // Diperluas dari 1900 menjadi 1500
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Bulan ke-${_hijriResult!['monthIndex']} '
                    'dalam tahun Hijriah '
                    '(${_hijriResult!['monthName']})',
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          Text(
                            '${_ageResult!['daysToNextBirthday']} Hari lagi',
